---
title: "for_thiopurine_analysis_with_cleaned"
...
```{r}
res <- fread("../result/leuco/leucoall_rev.Leukopenia.glm.logistic") %>% 
  arrange(P)

casefre <- fread("../result/leuco/case.afreq")
colnames(casefre) <- make.names(colnames(casefre))

cntfre <- fread("../result/leuco/cnt.afreq")
